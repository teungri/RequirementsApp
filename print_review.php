...
include_once("ini/txts/".$_SESSION['chlang']."/review_comments.php");
include_once("ini/txts/".$_SESSION['chlang']."/review_status.php");
...
//getting review info
$query2="select *, date_format(r_date, '%d.%m.%Y') as d1 from reviews where r_id=".$rev_id;
$rs2 = mysql_query($query2) or die(mysql_error());
if($row2=mysql_fetch_array($rs2)) 
 {
  $r_name=htmlspecialchars($row2['r_name']);
  $r_desc=$row2['r_desc'];
  $r_status=$row2['r_status'];
  $r_date=htmlspecialchars($row2['d1']);
  $r_p_id=$row2['r_p_id'];
  $p_id=$r_p_id;
 }
 
//getting list of ids for the review 
$query2="select * from review_requirements where rr_rev_id=".$rev_id;
$rs2 = mysql_query($query2) or die(mysql_error());
...
<!-- displaying the table with review info -->
 <table border="0" width="100%">
  <tr valign="top">
	...
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray">
	    <td class="gray" align="center" colspan=8><b><?=$lng[38][1]?></b></td>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right" >&nbsp;<?=$lng[39][6]?>:&nbsp;&nbsp;</td>
	    <td class="gray">&nbsp;<?=$r_name?></td>
	    <td class="gray" align="right" >&nbsp;<?=$lng[39][16]?>:&nbsp;&nbsp;</td>
	    <td class="gray">&nbsp;<?=$r_date?></td>
	    <td class="gray" align="right" >&nbsp;<?=$lng[39][12]?>:&nbsp;&nbsp;</td>
	    <td class="gray">&nbsp;<?echo $review_status_array[$r_status];?></td>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right" >&nbsp;<?=$lng[39][18]?>:&nbsp;&nbsp;</td>
	    <td class="gray" width="100%">
	    <?
	    $query2="select u.* from review_users ru left outer join users u on ru.ru_u_id=u.u_id where ru.ru_r_id='".$rev_id."' order by u.u_name asc";
	    $rs2 = mysql_query($query2) or die(mysql_error());
	    while($row2=mysql_fetch_array($rs2))
	     {
	...
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right" >&nbsp;<?=$lng[39][10]?>:&nbsp;&nbsp;</td>
	    <td class="gray" width="100%">&nbsp;<?=$r_desc?></td>
	  </tr>
	</table></td></tr> 
...
<!-- displaying the table with project info -->
 <table border="0" width="100%">
  <tr valign="top">
    <td>
      <table border="0" cellpadding="0" cellspacing="0" class="content" width="100%">
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray">
	    <td class="gray" align="center" colspan=8><b><?=$lng[17][7]?></b></td>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right" width="15%">&nbsp;<?=$lng[17][22]?>:&nbsp;&nbsp;</td>
	    <td class="gray"><?=$p_name?></td>
	    <td class="gray" align="right" >&nbsp;<?=$lng[15][99]?>:&nbsp;&nbsp;</td>
	    <td class="gray">
	    <?
	...
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right" >&nbsp;<?=$lng[17][19]?>:&nbsp;&nbsp;</td>
	    <td class="gray" colspan="7">&nbsp;<?=$p_leader?></td>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right"  width="15%">&nbsp;<?=$lng[17][23]?>:&nbsp;&nbsp;</td>
	    <td class="gray"><?if ($p_phase==0) echo $lng[9][8];?><?if ($p_phase==1) echo $lng[9][9];?><?if ($p_phase==2) echo $lng[9][10];?><?if ($p_phase==3) echo $lng[9][32];?><?if ($p_phase==4) echo $lng[9][33];?></td>
	    <td class="gray" align="right"  width="15%">&nbsp;<?=$lng[17][24]?>:&nbsp;&nbsp;</td>
	    <td class="gray"><?if ($p_status==0) echo $lng[9][11];?><?if ($p_status==1) echo $lng[9][12];?><?if ($p_status==2) echo $lng[9][14];?></td>
	    <td class="gray" align="right"  width="15%">&nbsp;<?=$lng[17][20]?>:&nbsp;&nbsp;</td>
	    <td class="gray" colspan="3">&nbsp;<?=$p_date?></td>	    
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="9" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right"  width="15%">&nbsp;<?=$lng[17][21]?>:&nbsp;&nbsp;</td>
	    <td class="gray" colspan="7">&nbsp;<?=$p_desc?></td>	    
	  </tr>
	</table></td></tr> 
	</table>
      </td> 
...
<!-- displaying  comments -->
	  ...
	  <?if ($comments) 
	    {
	     $query44="select rc.*, u.u_name, date_format(rc.rc_date, '%d.%m.%Y %H:%i') as d1 from review_comments rc left outer join users u on rc.rc_u_id=u.u_id where rc.rc_rev_id=".$rev_id." and rc.rc_req_id=".$r_id." order by rc_date desc";
             $rs44 = mysql_query($query44) or die(mysql_error());
             if (mysql_num_rows($rs44)>0) {?>
		<table border="0" width="100%">
		  <tr valign="top" colspan="8">
		    <td>
		      <table border="0" cellpadding="0" cellspacing="0" class="content" width="100%">
			  <tr class="gray">
			    <td align="center" colspan="4" width="100%" class="gray"><b><?=$lng[16][7]?></b></td>
			  </tr>
			  <?
			  while($row44=mysql_fetch_array($rs44)) 
			   {	  
			    ?>
			  <tr class="light_blue">
			    <td colspan="4" class="gray"><?=$lng[16][9]?>: <?=htmlspecialchars($row44['u_name'])?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$lng[16][10]?>: <?=htmlspecialchars($row44['d1'])?><br/>&nbsp;<?if($review_comments_array[$row44['rc_comment']]!="") echo $review_comments_array[$row44['rc_comment']].": ";?><?=htmlspecialchars($row44['rc_text'])?></td>
			  </tr>  
			  <?}?>
			</table>
		    </td> 	 
...
<!-- displaying  review comments -->
	  <?//if review comments to be shown
	  if ($comments) 
	    {
    	          $query44="select rc.*, u.u_name, date_format(rc.rc_date, '%d.%m.%Y %H:%i') as d1 from review_comments rc left outer join users u on rc.rc_u_id=u.u_id where rc.rc_rev_id=".$rev_id." order by rc_date desc";
		  $rs44 = mysql_query($query44) or die(mysql_error());
		  if (mysql_num_rows($rs44)>0) {
		  ?>
		<table border="0" width="100%">
		  <tr valign="top" colspan="8">
		    <td>
		      <table border="0" cellpadding="0" cellspacing="0" class="content" width="100%">
			  <tr class="gray">
			    <td align="center" width="100%"><b><?=$lng[16][25]?></b></td>
			  </tr>
			  <?
			  while($row44=mysql_fetch_array($rs44)) 
			   {	  
			    ?>
			  <tr class="light_blue">
			    <td><?=$lng[16][9]?>: <?=htmlspecialchars($row44['u_name'])?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$lng[16][10]?>: <?=htmlspecialchars($row44['d1'])?><br/>&nbsp;<?if($review_comments_array[$row44['rc_comment']]!="") echo $review_comments_array[$row44['rc_comment']].": ";?><?=htmlspecialchars($row44['rc_text'])?></td>
			  </tr>  
			  <?}?>
			</table>
		    </td> 	 
