...
// -----------------------------------------------------------------
//
// Page: "popup components" - editing/adding/deleting components in a popup
...
if ($action=="add")
 {
  ...
  $c_id=mysql_insert_id();  
    ...
    <script>
      ...
      opener.document.forms['edit'].r_component.value+=<?=$c_id?>+",";
	...
	<table border="0" cellpadding="2" cellspacing="2" class="content" width="100%">
	  ...
	  <tr class="gray">
	    <td colspan="2" align="center">
	       <input type="button" onclick="sub('add');" value="<?=$lng[37][2]?>">
	    </td>
	  </tr>   
	</table>
