...
<!-- displaying the table with project info -->
 <table border="0" width="100%">
  <tr valign="top">
	...
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    <td class="gray" align="right" >&nbsp;<?=$lng[15][115]?>:&nbsp;&nbsp;</td>
	    <td class="gray">
	    <?
	    ...
	    <td class="gray" colspan="3">&nbsp;<?=$p_leader?></td>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
...
<!-- displaying the table with the selected requirement info -->
<table border="0" cellpadding="0" cellspacing="0" class="content" width="100%">
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	 <tr class="gray" valign="top">
	    <td class="gray" align="center">&nbsp;</td>
	    <td class="gray" align="center" colspan="7" ><b><?=$lng[16][1]?></b></td>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8">
	...
	<tr><td colspan="8"><table border="0" cellpadding="9" cellspacing="3" width="100%">
	  ...
	  <tr class="gray" valign="top">
	    ...
	    <td class="gray" align="left" colspan="7" width="100%"><?=$ta?></td>
	  </tr> 
...
<!-- displaying tables with the historization info for the selected requirement -->
  ...
  <tr valign="top">
	...
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr class="gray" valign="top">
	    ...
	    <td class="gray" align="center" colspan=6><b><?if ($cnt==1){?><?=$lng[16][6]?><?}?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
	  </tr>
	</table></td></tr> 
	...
	<tr><td colspan="8"><table border="0" cellpadding="9" cellspacing="3" width="100%">
	  ...
	  <?}else {echo '<tr valign="top"><td class="gray">&nbsp;</td><td colspan="7" class="gray">&nbsp;</td></tr>';}?>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr valign="top">
	  <?if ($project) {?>
	  ...
	  <?}else {echo '<td width="15%" class="gray">&nbsp;</td><td class="gray">&nbsp;</td>';}?>
	  <?if ($subproject) {?>
	  ...
	  <?}else {echo '<td class="gray">&nbsp;</td><td colspan="3" class="gray">&nbsp;</td>';}?>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr valign="top">
	...
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  ...
	  <?}else {echo '<td class="gray">&nbsp;</td><td colspan="5" class="gray">&nbsp;</td>';}?>
	  </tr>
	</table></td></tr> 
	<tr><td colspan="8"><table border="0" cellpadding="3" cellspacing="3" width="100%">
	  <tr valign="top">
	...
	<tr><td colspan="8"><table border="0" cellpadding="9" cellspacing="3" width="100%">
	  ...
	  <?if ($weight) {?>
	    ...
	    <td class="<?=$cl29?>" align="left"><?=$r_weight?></td> 
	  <?}else {echo '<td class="gray">&nbsp;</td><td class="gray">&nbsp;</td>';}?>
	  <?if ($open_points) {?>
	    <td class="<?=$cl24?>" align="right" >&nbsp;<?=$lng[15][44]?>:&nbsp;&nbsp;</td>
	    <td class="<?=$cl24?>" align="left"><?=$r_points?></td>
	  <?}else {echo '<td class="gray">&nbsp;</td><td class="gray">&nbsp;</td>';}?>
	  <?if ($keywords) {?>
...
<table border="0" width="100%">
  <tr valign="top">
    <td>
      <table border="0" cellpadding="8" cellspacing="8" class="content" width="100%">
	  <tr class="gray">
...
<table border="0"  cellpadding="0" cellspacing="0" width="100%">
  <tr valign="top">
    <td>
      <table border="0" cellpadding="3" cellspacing="3" class="content" width="100%">
	  <tr class="gray">
	  ...
	  while($row44=mysql_fetch_array($rs44)) 
	   {	  
	    ?>
	  <tr class="gray">
	    <td align="right"  class="gray">&nbsp;<?=$lng[16][9]?>:&nbsp;&nbsp;</td>
	    <td class="gray">&nbsp;<?=htmlspecialchars($row44['u_name'])?></td>
	    <td align="right"  class="gray">&nbsp;<?=$lng[16][10]?>:&nbsp;&nbsp;</td>
	    <td class="gray">&nbsp;<?=($row44['c_date']!="00.00.0000")?$row44['c_date']:""?></td>
	  </tr>  
	  <tr class="light_blue">
	    <td colspan="4" class="gray">&nbsp;<?=$row44['c_text']?></td>
	    ...
	    <td>
		  ...
		  while($row44=mysql_fetch_array($rs44)) 
		   {	  
		    ?>
		  <tr class="gray">
		    <td align="right"  class="gray">&nbsp;<?=$lng[25][3]?>:&nbsp;&nbsp;</td>
		    <td class="gray">&nbsp;<?for ($i=0;$i<6-strlen($row44['g_id']);$i++) echo "0";echo $row44['g_id'];?></td>
		    <td align="right"  class="gray">&nbsp;<?=$lng[25][5]?>:&nbsp;&nbsp;</td>
		    <td class="gray">&nbsp;<?=htmlspecialchars($row44['g_term'])?></td>
		    <td align="right"  class="gray">&nbsp;<?=$lng[25][6]?>:&nbsp;&nbsp;</td>
		    <td class="gray">&nbsp;<?=htmlspecialchars($row44['g_abbreviation'])?></td>
		  </tr>  
		  <tr class="light_blue">
		    <td align="right"  class="gray">&nbsp;<?=$lng[25][12]?>:&nbsp;&nbsp;</td>
		    <td colspan="5" class="gray">&nbsp;<?=$row44['g_desc']?></td>
		  </tr>  
		  <tr class="light_blue">
		    <td align="right"  class="gray">&nbsp;</td>
		    <td colspan="5" class="gray"><br/></td>
		  </tr>  
		  <?}?>
		</table>
	    </td> 	 
