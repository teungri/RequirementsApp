  ...
  <tr valign="top">
    <td>
	  ...
	  <tr class="gray">
	    ...
	    <td align="left" colspan="3">&nbsp;&nbsp;<input <?if ($accepted_user==1 || $accepted_user=="") echo "checked";?> type="checkbox" name="accepted_user" value="1">&nbsp;<?=$lng[15][20]?></td>
	  </tr>
	  <tr class="gray">
	    <td align="center" colspan="5">
	      <input type="button" value="<?=$lng[35][2]?>" onclick="document.forms['f1'].action='pdf.php';document.forms['f1'].submit();">&nbsp;&nbsp;
	      <?
	  ...
	  <input type="hidden" name="project_list" value="<?=$project_list?>">
