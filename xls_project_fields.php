...
// -----------------------------------------------------------------
//
// Page: "xls fields" - list of fields
  ...
  <tr valign="top">
    <td>
	  ...
	  <tr class="gray">
	    ...
	    <td align="left" colspan="3">&nbsp;&nbsp;<input <?if ($comments==1 || $comments=="") echo "checked";?> type="checkbox" name="comments" value="1">&nbsp;<?=$lng[15][114]?></td>
	  </tr>
	  <tr class="gray">
	    <td align="center" colspan="5">
	      <input type="button" value="<?=$lng[35][8]?>" onclick="document.forms['f1'].action='xls.php';document.forms['f1'].submit();">&nbsp;&nbsp;
	      <?
