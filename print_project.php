		...
		<table border="0" width="100%">
		  <tr valign="top" colspan="8">
		    <td>
		      <table border="0" cellpadding="0" cellspacing="0" class="content" width="100%">
			  <tr class="gray">
			    <td align="center" colspan="6" width="100%" class="gray"><b><?=$lng[24][1]?></b></td>
			  </tr>
			  <?
			  while($row44=mysql_fetch_array($rs44)) 
			   {	  
		...
		<table border="0" width="100%">
		  <tr valign="top" colspan="8">
		    <td>
		      <table border="0" cellpadding="0" cellspacing="0" class="content" width="100%">
			  <tr class="gray">
			    <td align="center" colspan="4" width="100%" class="gray"><b><?=$lng[31][1]?></b></td>
			  </tr>
			  <?
			  while($row44=mysql_fetch_array($rs44)) 
			   {	  
			    ?>
			  <tr class="gray">
			    <td align="right"  class="gray">&nbsp;<?=$lng[31][2]?>:&nbsp;&nbsp;</td>
			    <td>&nbsp;<?=htmlspecialchars($row44['c_name'])?></td>
			    <td align="right"  class="gray">&nbsp;<?=$lng[31][5]?>:&nbsp;&nbsp;</td>
			    <td>&nbsp;
			    <?
			  ...
			  <tr class="light_blue">
			    <td align="right"  class="gray">&nbsp;<?=$lng[31][3]?>:&nbsp;&nbsp;</td>
			    <td colspan="3" class="gray">&nbsp;<?=$row44['c_desc']?></td>
			  </tr>  
			  <tr class="light_blue">
			    <td align="right"  class="gray">&nbsp;<?=$lng[31][4]?>:&nbsp;&nbsp;</td>
			    <td colspan="3" class="gray">&nbsp;<?=$row44['c_result']?></td>
			  </tr>  
			  <tr class="light_blue">
			    <td align="right"  class="gray">&nbsp;</td>
			    <td colspan="3" class="gray"><br/></td>
			  </tr>  
			  <?}?>
			</table>
		    </td> 	 
...
<?}?>
<?}?>
 <!-- displaying glossary (in the end of all) -->	  
	  <?//if glossary to be shown
	  if ($glossary) 
	    {
	     
		  $query44="select * from glossary where g_id in (".$glossary_ids2."0) order by g_name asc";
		  $rs44 = mysql_query($query44) or die(mysql_error());
		  if (mysql_num_rows($rs44)>0) {
		  ?>
		<table border="0" width="100%">
